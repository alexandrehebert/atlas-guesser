...
export default function GameSidebar() {
  ...
  const { sidebarOpen, isMobile, sidebarRef, sidebarToggleRef } = useGameLayout();
  ...
  const desktopWrapperClass =
    ...
    (sidebarOpen
      ...
      : ' translate-x-[calc(100%-1rem)] opacity-100');
